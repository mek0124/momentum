...
todo/
  - cli/
    - a [Click](https://click.palletsprojects.com/en/stable/) console application (Python)
  - tui/
    - a [Textual](https://textual.textualize.io/tutorial/) text-based user interface within the console (Python)
  - desktop/
    - a [PySide6](https://doc.qt.io/qtforpython-6/index.html) GUI application (Python)
  - mobile/
    - an [Expo](https://docs.expo.dev/) typescript mobile application (Node)
  - web/
    - a [NextJS](https://nextjs.org/docs) typescript web application (Node)
